...
// console.log(job)
for(i=0;i<job.hits.length;i++){
    console.log(i, job.hits[i].jobTitle)
    console.log(i, job.hits[i].locations)
    console.log(i, job.hits[i].jobSalary)
    console.log(i, job.hits[i].benefits)
    console.log(i, job.hits[i].skills)
    console.log(i, job.hits[i].jobRequirement)
}